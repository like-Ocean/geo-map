import { useSearchLocationsQuery } from '@renderer/api/nominatim/location/search-locations';
import { LocationSearchItem } from '@renderer/components/common/location-search-item';
