...
import { calculateTension } from '@/utils/tension-calculator';
...
export const useHexagonStoreBase = create<HexagonState & HexagonActions>()(
  (set, get) => ({
    cellSize: 45,
    hexagonValues: {},
    userValues: {},
    ...
    recalculateTension: () => {
      ...
      const newValues = mergedGrid.reduce((acc, hex) => {
